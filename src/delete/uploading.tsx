...
function Description({ content, setContent }: any) {
  return (
...
function Tag({ tagString, setTagString }: any) {
  return (
    <div className="card-body p-1">
...
function AddImage({ isModifying }: any) {
  return (
    <div className="card-body p-1">
      {isModifying ? (
        <>
...
function Button({ isModifying, clkFunc }: any) {
  const createArticle = () => {
...
function Uploading({ isModifying, file, isLogin, clkFunc }: any) {
