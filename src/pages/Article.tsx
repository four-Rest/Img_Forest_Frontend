...
import Uploading from "../delete/uploading";
...
function Article() {
    ...
    if (paid) {
      return (
        <div className="card-body p-1">
          <label htmlFor="price" className="card-title">
            가격
          </label>
          <input
            type="text"
  ...
  //       // toastWarning("로그인이 필요한 서비스입니다."); << 통일 필요
  //       return;
  //     }
  ...
  return (
    <>
      <Uploading isModifying={false} />
      {/* <div className="card-body p-1">
        <label htmlFor="paid" className="card-title">
          유료화 선택
        </label>
        <input
          type="checkbox"
